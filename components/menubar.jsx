...
<h1 >NHMP TRAINING COLLEGE SHEIKHUPURA</h1>
   ...
   <MenubarMenu>
    ...
    <Link href ='/trainee/registeration'>Trainee Registration Form</Link>
    </MenubarTrigger>
  </MenubarMenu>
  ...
  {/* =========================second */}
  <MenubarMenu>
    <MenubarTrigger> <SiGoogleforms  size ={16} className='mr-2'/>HRM Forms</MenubarTrigger>


    <MenubarContent className=" rounded-none bg-white">
    <MenubarItem> <TbTimelineEventPlus className='mr-2'/><Link href ='/trainee/leave'>Add Trainee Leave</Link></MenubarItem>
      <MenubarSeparator />
      <MenubarItem> <SiGoogleclassroom className='mr-2'/><Link href ='/trainee/punishment'>Add Trainee Punishment</Link></MenubarItem>
      <MenubarSeparator />
      
      <MenubarItem> <AiOutlineApartment className='mr-2'/><Link href ='/trainee/absence'>Add Trainee Absence
      </Link></MenubarItem>
      <MenubarSeparator />
      <MenubarItem> <BsCashCoin className='mr-2'/> <Link href ='/trainee/result'>Add Trainee Results</Link>
      </MenubarItem>

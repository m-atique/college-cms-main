...
export const columns: ColumnDef<Payment>[] = [  
  {
    ...
    header: "Picture",
    cell: ({row}) => {
      const pic = row.getValue("photo")
      return <div className={`h-12 w-12 rounded-full bg-cover bg-center border border-second 
      `}

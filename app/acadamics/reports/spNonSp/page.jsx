"use client"
import Sapphirains from './printmodal'
...
useEffect(()=>{
  const getData=async()=>{
    ...
    const response = await axios.get(`${ds}/std/spNonSp`)
...
<div className=' w-3/12  flex justify-center items-center'>
  ...
  <div className='flex items-center justify-center '>
    <div  className='flex items-center justify-center '>
      ...
      <Sapphirains ref={componentRef} data= {data} class={cls} section={sec} />
    </div>
  </div>

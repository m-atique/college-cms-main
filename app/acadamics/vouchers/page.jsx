"use client"
import FeeVoucherSheet from './feesVoucher'
...
const Fv = () => {
  ...
  return (
    ...
    <div className=' flex justify-between py-2 px-3  bg-slate-200 m-2 rounded-md' >
      ...
      <button onClick={handlePrint}  className='bg-second rounded-md px-3 py-2 text-white'>Print this out!</button>
    </div>
        <FeeVoucherSheet ref={componentRef} />
    </div>
    </div>
  )
}
